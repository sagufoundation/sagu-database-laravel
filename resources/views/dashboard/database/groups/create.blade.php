...
{!! Form::open(array('url' => route('dashboard.groups.store'),'files'=>'true')) !!}
@csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="group_title" id="group_title" value="{{ old('group_title') ?? '' }}" placeholder="Group title" class="form-control">
