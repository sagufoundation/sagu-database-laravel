...
{!! Form::open(array('url' => route('dashboard.programs.update',$data->id),'files'=>'true')) !!}
@csrf
@method('put')
<div class="row">
    <div class="col-lg-12">
                             ...
                             <div class="mb-3">
                                ...
                                <select name="group_id" id="" class="form-control">
                                    ...
                                    @foreach ($groups as $group )
                                        <option @if(old('group_id') ?? $data->group_id == $group->id) {{'selected'}} @endif value="{{$group->id}}">{{$group->group_title}}</option>
