...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="mb-3">
            ...
            <span class="text-danger" role="alert">
                <small class="pt-1 d-block"><i class="fe-alert-triangle mr-1"></i> {{ $errors->first('first_name')
                    }}</small>
            </span>
            @endif
        </div>
    ...
    <div class="col-md-4">
        <div class="mb-3">
            ...
            <input type="text" name="middle_name" id="middle_name"
                value="{{ old('middle_name') ?? $data->middle_name }}" placeholder="Middle Name" class="form-control">
            @if ($errors->has('middle_name'))
            <span class="text-danger" role="alert">
                <small class="pt-1 d-block"><i class="fe-alert-triangle mr-1"></i> {{ $errors->first('middle_name')
                    }}</small>
            </span>
            @endif
        </div>
    ...
    <div class="col-md-4">
        <div class="mb-3">
            ...
            <span class="text-danger" role="alert">
                <small class="pt-1 d-block"><i class="fe-alert-triangle mr-1"></i> {{ $errors->first('last_name')
                    }}</small>
            </span>
            @endif
        </div>
    ...
    <div class="col-md-4">
        <div class="mb-3">
            ...
            <span class="text-danger" role="alert">
                <small class="pt-1 d-block"><i class="fe-alert-triangle mr-1"></i> {{ $errors->first('place_of_birth')
                    }}</small>
            </span>
            @endif
        </div>
    ...
    <div class="col-md-4">
        <div class="mb-3">
            ...
            <input type="date" name="date_of_birth" id="date_of_birth"
                value="{{ old('date_of_birth') ?? $data->student->date_of_birth ?? '' }}" placeholder="Date of bith"
                class="form-control">
            @if ($errors->has('date_of_birth'))
            <span class="text-danger" role="alert">
                <small class="pt-1 d-block"><i class="fe-alert-triangle mr-1"></i> {{ $errors->first('date_of_birth')
                    }}</small>
            </span>
            @endif
        </div>
