                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description"  cols="30" rows="5" class="form-control" placeholder="A short description about this category">{{ old('description',$data->description) ?? '' }}</textarea>
