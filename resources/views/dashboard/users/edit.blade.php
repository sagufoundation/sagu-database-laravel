                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password_confirmation" name="password_confirmation" id="password_confirmation" placeholder="*********" class="form-control">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-2 p-0">
                                @if (!$data->picture)
                                <img src="{{ asset('images/' . Request::segment(2) . '/00.jpg') }}" alt="Profile image not found" class="img img-thumbnail w-100" id="preview-images" width="80">
                                @else
