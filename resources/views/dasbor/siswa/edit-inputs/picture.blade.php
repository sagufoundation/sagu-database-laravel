...
<div class="row">
    <div class="col-md-4">
        ...
        <div class="form-group">
            <div class="mb-2">
                @if($data->picture)
                <img src="{{ asset('gambar/siswa/'. $data->picture) }}" alt="Gambar" id="preview-gambar" class="img-thumbnail w-100">
                @else 
                <img src="{{ asset('gambar/siswa/00.jpg') }}" alt="Gambar" id="preview-gambar" class="img-thumbnail w-100">
                @endif
