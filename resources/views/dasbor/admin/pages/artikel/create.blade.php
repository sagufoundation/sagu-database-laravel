    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <!-- <form action="{{ url('app/artikel') }}" method="POST" enctype="multipart/form-data"> -->
                {!! Form::open(array('url' => 'app/artikel','files'=>'true')) !!}
                @csrf
                ...
                <div class="mb-3">
                    ...
                    {!!
                    Form::text('deskripsi',null,['required','id'=>'deskripsi','class'=>'form-control','placeholder'=>'Deskripsi',
                    'required']) !!}
                </div>
                ...
                <div class="mb-3">
                    ...
                    <!-- <input type="text" id="subtitle" name="subtitle" class="form-control" placeholder="Sub Title" required> -->
                    {!!
                    Form::text('katakunci',null,['required','id'=>'katakunci','class'=>'form-control','placeholder'=>'Kata
                    Kunci', 'required']) !!}
                </div>
                ...
                <div class="mb-3">
                    ...
                    {!! Form::select('kategori_id', [''=>'Pilih
                    kategori']+App\Models\Kategori::pluck('title','id')->all(),
