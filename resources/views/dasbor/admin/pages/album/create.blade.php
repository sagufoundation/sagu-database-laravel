    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <!-- <form action="{{ url('app/album') }}" method="POST" enctype="multipart/form-data"> -->
                {!! Form::open(array('url' => 'app/album','files'=>'true')) !!}
                @csrf
                ...
                <div class="mb-3">
                    <label for="deskripsi" class="form-label">Subtitle <span class="text-danger">*</span></label>
                    <!-- <input type="text" id="subtitle" name="subtitle" class="form-control" placeholder="Sub Title" required> -->
                    {!!
                    Form::text('subtitle',null,['required','id'=>'subtitle','class'=>'form-control','placeholder'=>'Subtitle',
                    'required']) !!}
                </div>
