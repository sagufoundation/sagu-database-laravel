...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                {!! Form::open(array('url' => 'app/faq','method'=>'post')) !!}
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="jawaban" class="ckeditor form-control" id="jawaban" value="{{ old('jawaban') }}"
                        cols="30" rows="10">{{ old('jawaban') }}</textarea>
                </div>
