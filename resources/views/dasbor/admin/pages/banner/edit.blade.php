    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label for="product-reference" class="form-label">Sub Title <span
                ...
                <div class="mb-3">
                    <label for="product-reference" class="form-label">Link <span class="text-danger">*</span></label>
                    <!-- <input type="text" id="subtitle" name="subtitle" class="form-control" placeholder="Sub Title" required> -->
                    {!! Form::text('link',null,['required','id'=>'link','class'=>'form-control','placeholder'=>'link',
                    'required']) !!}
                </div>

                <div class="mb-3">
                    <label for="product-category" class="form-label">Status <span class="text-danger">*</span></label>
                    {!! Form::select('status', [''=>'Status ...','Publish'=>'Aktif','Draft'=>'draft'],
    ...
    <div class="col-lg-6">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <!-- Preview -->
                <p class="text-muted">Max File size 1 MB</p>
...
<div class="row">
    <div class="card">
        <div class="card-body">
            ...
            <a href="{{ route('app.banner') }}" class="btn btn-light">
