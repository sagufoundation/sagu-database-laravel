    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-4">
                        <a href="{{ url('dasbor/pesan') }}" class="btn btn-danger mb-2 waves-effect waves-light"><i class="mdi mdi-arrow-left me-2"></i> Kembali</a>
                    </div>
                    <div class="col-sm-8">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="row">
                                    <div class="col-6">
                                        <form action="{{ url('dasbor/pesan/restore',$data->id) }}" method="POST">
                                            @csrf
                                            <button type="submit" class="btn btn-success">Restore</button>
                                        </form>
                                    </div>
                                    <div class="col-6">
                                        <form action="{{ url('dasbor/pesan/delete',$data->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
